            ...
            <div className="container">
                ...
                <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-4 lg:grid-cols-3 ">
                    ...
                    >
                        <div className="flex aspect-video justify-center items-center ">
                            <div className=" border-blue-400 size-20 border-4 rounded-full  p-1 overflow-hidden z-40 bg-neutral-900">
                                <Image
                                    src={avatar1}
                                    alt="Avatar 1"
                            ...
                            <div className=" border-orange-400 size-20 overflow-hidden bg-neutral-900 border-4 rounded-full p-1 z-20 -ml-6">
                                <Image
                                    src={avatar2}
                                    alt="avatar2"
                                    className="border rounded-full"
                    ...
                    >
                        <div className="aspect-video flex items-center justify-center ">
                            <p className="text-4xl text-center font-extrabold text-white/20">
                                We&apos;ve achieved{" "}
                                <span className="block bg-gradient-to-r from-purple-400 to-pink-400 text-transparent bg-clip-text font-bold">
                                    incredible
                                </span>{" "}
                                growth this year{" "}
                            </p>
                ...
                <div className="mt-8 flex flex-wrap  gap-3 justify-center items-center md:mt-14 lg:mt-8 ">
                    {features.map((feature) => (
                        <div
                            key={feature}
                            className="bg-neutral-900 border border-white/10 px-3 inline-flex py-1.5 rounded-2xl gap-3 items-center md:px-5 md:py-2"
                        >
                            <span className="size-5 inline-flex justify-center items-center  rounded-full bg-lime-400 text-neutral-950 text-xl">
                                &#10038;
                            </span>
